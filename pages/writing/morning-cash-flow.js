...
const Article1 = () => {
  ...
  return (
    <div style={articleStyle}>
      ...
      <Image src="/morning-cash-flow/portfolio.png" alt="Portfolio Holdings" width={800} height={450} style={{ marginBottom: '5px' }} />
      ...
      <Image src="/morning-cash-flow/program-trade-code.png" alt="Program Trade Code" width={800} height={450} style={{ marginBottom: '5px' }} />
      ...
      <Image src="/morning-cash-flow/program-trade.png" alt="Proposed Trade" width={800} height={450} style={{ marginBottom: '5px' }} />
      <Image src="/morning-cash-flow/program-trade-summary.png" alt="Program Trade Summary" width={800} height={450} style={{ marginBottom: '5px' }} />
      ...
      <Image src="/morning-cash-flow/portfolio-exclude-buy.png" alt="Portfolio Exclude Buy" width={800} height={450} style={{ marginBottom: '5px' }} />
      ...
      <Image src="/morning-cash-flow/portfolio-exclude-trade.png" alt="Portfolio Exclude Trade" width={800} height={450} style={{ marginBottom: '5px' }} />
    </div>
  );
};
