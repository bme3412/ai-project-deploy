...
const Article1 = () => {
  ...
  return (
    <div style={articleStyle}>
      ...
      <p style={paragraphStyle}> Note: All figures are simulated. Link to code notebooks can be found <a href="https://github.com/bme3412/AI_Projects_with_Python/tree/main/cash-flow">here</a>.</p>
      ...
      <p style={paragraphStyle}>
        ...
        client-driven redemption that is 12% of the portoflio, while a new
      ...
      <p style={paragraphStyle}>
        ...
        client-directed restrictions of certain securities. Trades are procesed
        in Aladdin but the department operates wth a "Second Set of Eyes" policy
      ...
      <img src="/morning-cash-flow/portfolio.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
      ...
      It's a $75m account with the same positions, and a program trade is needed to raise enough cash to cover this outflow. While the trades will be implemented in Blackrock Aladdin, a Python workload can be used to map out trades.</p>
      ...
      <img src="/morning-cash-flow/program-trade-code.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
      ...
      <img src="/morning-cash-flow/program-trade.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
      <img src="/morning-cash-flow/program-trade-summary.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
      ...
      <img src="/morning-cash-flow/portfolio-exclude-buy.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
      ...
      <img src="/morning-cash-flow/portfolio-exclude-trade.png" alt="Image 1" style={{ width: '100%', height: 'auto', marginBottom: '5px' }} />
