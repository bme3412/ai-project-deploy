...
const Article1 = () => {
  ...
  const handleImageClick = (imageSrc) => {
    setExpandedImage(imageSrc === expandedImage ? null : imageSrc);
  };
  ...
  return (
    <div style={styles.article}>
      ...
      <h2 style={styles.header}>Exploring Agentic Workflows with Llama-Index</h2>
      ...
      <div style={styles.imageContainer}>
        <Image
          ...
          height={600}
          style={
            expandedImage === "/llama-index-agents/chatbot-query-1.png"
              ? styles.expandedImage
              : styles.image
          }
          onClick={() =>
            handleImageClick("/llama-index-agents/chatbot-query-1.png")
          }
        />
        <Image
          ...
          height={600}
          style={
            expandedImage === "/llama-index-agents/chatbot-response-1.png"
              ? styles.expandedImage
              : styles.image
          }
          onClick={() =>
            handleImageClick("/llama-index-agents/chatbot-response-1.png")
          }
        />
      </div>
      <p style={styles.paragraph}>
      ...
      <Image
        ...
        height={600}
        style={
          expandedImage === "/llama-index-agents/openai-agent-thread.png"
            ? styles.expandedImage
            : styles.fullWidthImage
        }
        onClick={() =>
          handleImageClick("/llama-index-agents/openai-agent-thread.png")
        }
      />
      <p style={styles.paragraph}>
      ...
      <Image
        ...
        height={600}
        style={
          expandedImage === "/llama-index-agents/multi-document.png"
            ? styles.expandedImage
            : styles.fullWidthImage
        }
        onClick={() =>
          handleImageClick("/llama-index-agents/multi-document.png")
        }
      />
      <p style={styles.paragraph}>
        Finally, we set up an agent that can effectively answer different types
        of questions over a larger set of documents. The below function extracts
        information from multiple 10-K PDF documents, builds agents and tools to
        query the documents, and exposes an API endpoint to allow users to query
        the documents and retrieve relevant information.
      </p>
      <div
        style={{
      ...
      >
        <p style={{ marginBottom: "10px" }}>
          <span style={{ fontWeight: "bold", color: "#333" }}>Query:</span>{" "}
          Compare and contrast the key industry themes and business fundamentals
          for each company?
        </p>
        <p>
          <span style={{ fontWeight: "bold", color: "#333" }}>Response:</span>{" "}
          The key industry themes and business fundamentals for each company in
          2023 are as follows:
        </p>
        <div style={{ marginBottom: "20px" }}>
          <h3 style={{ color: "#007bff" }}>Apple Inc. (AAPL):</h3>
          <p>
            <strong>Key Industry Themes:</strong>
          </p>
          ...
          <ul style={{ listStyleType: "disc", marginLeft: "20px" }}>
            <li>
              Strong financial performance with robust revenue growth and
              profitability
            </li>
            <li>
              Operational efficiency in managing costs and optimizing resources
            </li>
            <li>
              Solid competitive positioning with a strong brand and diverse
              product portfolio
            </li>
        ...
        <div>
          ...
          <ul style={{ listStyleType: "disc", marginLeft: "20px" }}>
            <li>
              Navigating geopolitical challenges and foreign policy landscapes
            </li>
            <li>
              Adapting products and services to changing technology platforms
            </li>
        ...
        <p>
          These themes and fundamentals are central to the operations,
          strategies, and success of Apple, Amazon, and Google in 2023.
        </p>
        <p>
          Links for all notebooks can be found here:{" "}
          <a
            href="https://github.com/bme3412/AI_Projects_with_Python/tree/main/LlamaIndex/Agents"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://github.com/bme3412/AI_Projects_with_Python/tree/main/LlamaIndex/Agents
          </a>
        </p>
      </div>
    </div>
